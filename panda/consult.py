"""
Panda Agent — Expert Consultation Module (专家会诊模块)
=====================================================
...
from panda.jury import JuryDebate, JuryVerdict, VoteDecision, Ballot, DebateRound
from panda.explorer import ExplorerEnsemble, ExplorationResult, ExplorerConfig, ExploreStrategy
...
logger = logging.getLogger("panda.consult")
...
class ExpertConsultation:
    ...
    Parameters:
        dispatcher: Configured PandaDispatcher for all LLM calls.
