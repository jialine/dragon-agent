"""
Panda Agent cost optimization module.
...
def _get_default_db_path() -> str:
    ...
    # Resolve relative to the project root (parent of the panda package)
    this_dir = Path(__file__).resolve().parent  # panda/utils/
    project_root = this_dir.parent.parent       # panda-agent/
    data_dir = project_root / "panda_data"
...
class CostOptimizer:
    ...
    db_path : str | None
        Path to the SQLite database.  Default: ``panda_data/cost.db``.
    """
    ...
    def __init__(
        ...
        self._logger = logging.getLogger("panda.cost")
