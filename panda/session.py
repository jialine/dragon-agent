"""
Panda Session — SQLite session store with FTS5 full-text search.
...
logger = logging.getLogger("panda.session")
...
class SessionStore:
    ...
    Usage::
        ...
        store = SessionStore(db_path="panda_data/sessions.db")
    ...
    def __init__(self, db_path: str = "panda_data/sessions.db") -> None:
