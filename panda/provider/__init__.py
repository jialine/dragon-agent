"""
Panda Provider — Unified LLM Provider Abstraction Layer
========================================================
...
Usage::
    ...
    from panda.provider import ProviderRegistry, create_openai, create_deepseek
...
logger = logging.getLogger("panda.provider")
...
def auto_setup_providers() -> ProviderRegistry:
    ...
    # Local llama.cpp
    model_path = os.getenv("PANDA_LOCAL_MODEL", "")
