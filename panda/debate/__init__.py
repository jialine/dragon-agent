"""
Panda Agent — Goal Backward Engine (目标倒推引擎)
...
# Structured logging
# ────────────────────────────────────────────────────────────────────
logger = logging.getLogger("panda.debate")
...
class GoalBackwardEngine:
    ...
    Parameters:
        dispatcher: A configured :class:`PandaDispatcher` for LLM calls.
    ...
    def __init__(
        ...
        Args:
            dispatcher: Configured PandaDispatcher instance for LLM calls.
