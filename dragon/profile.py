"""
Dragon Profile — Multi-tenant isolation for independent agent instances.
...
Usage::
    ...
    pm = ProfileManager(base_dir="~/.dragon/profiles")
...
logger = logging.getLogger("dragon.profile")
...
class ProfileManager:
    ...
    ----------
    base_dir : str
        Root directory for all profiles (default: ~/.dragon/profiles).
    """

    def __init__(self, base_dir: str = "~/.dragon/profiles") -> None:
