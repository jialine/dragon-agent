"""
Dragon Subagent Delegation — Spawn independent agents for parallel task execution.
...
- Skill inheritance (subagents can use Dragon's self-evolving skills)
...
logger = logging.getLogger("dragon.subagent")
