"""
Dragon Cron — Lightweight task scheduler for recurring jobs.
...
Usage::
    ...
    scheduler = CronScheduler(db_path="dragon_data/cron.db")
    scheduler.start()
...
logger = logging.getLogger("dragon.cron")
...
class CronScheduler:
    ...
    def __init__(
        self,
        db_path: str = "dragon_data/cron.db",
