"""
Dragon Agent — Explorer Ensemble Module
=======================================
...
from dragon.dispatch import DragonDispatcher, DispatchResult, ProviderProfile
from dragon.guard import AntiLoopGuard, LoopAction, ActionType, LoopDetection
from dragon.utils.cost import CostOptimizer, MODEL_TIERS, _find_tier_for_model

# ────────────────────────────────────────────────────────────────────
# Logger
# ────────────────────────────────────────────────────────────────────
logger = logging.getLogger("dragon.explorer")
...
class ExplorerConfig:
    ...
    def to_provider_profile(self) -> ProviderProfile:
        """Convert to a :class:`ProviderProfile` for the DragonDispatcher."""
...
class ExplorerEnsemble:
    ...
    async def explore(
        ...
        # ── 0.5. Interrupt check ────────────────────────────────────
        try:
            from dragon.interrupt import get_interrupt_manager
