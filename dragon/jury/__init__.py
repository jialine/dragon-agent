"""
Dragon Agent — Jury Debate Engine (评审辩论引擎)
...
# Structured logging
# ────────────────────────────────────────────────────────────────────
logger = logging.getLogger("dragon.jury")
...
class JuryDebate:
    ...
    Parameters:
        dispatcher: Configured :class:`DragonDispatcher` for all LLM calls.
    ...
    async def _dispatch_to_juror(
        ...
        """Dispatch a prompt to a single juror via the DragonDispatcher.
